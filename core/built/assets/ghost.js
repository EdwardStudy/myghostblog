  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        attribute(env, attrMorph10, element10, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/pborreli"]));
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        var el4 = dom.createTextNode("一个简单、纯粹的内容写作和发布平台。");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n\n        ");
        dom.appendChild(el2, el3);
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, block = hooks.block, content = hooks.content, get = hooks.get, inline = hooks.inline, subexpr = hooks.subexpr, concat = hooks.concat, attribute = hooks.attribute;
        dom.detectNamespace(contextualElement);
        var fragment;
        if (env.useFragmentCache && dom.canClone) {
          if (this.cachedFragment === null) {
        ...
        var morph6 = dom.createMorphAt(dom.childAt(element2, [19]),0,0);
        var morph7 = dom.createMorphAt(dom.childAt(element3, [3]),1,1);
        ...
        content(env, morph6, context, "model.storage");
        inline(env, morph7, context, "partial", ["contributors"], {});
...
if (runningTests) {
  ...
  require("ghost/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"ghost","version":"0.0.0.c164df4f"});
}
